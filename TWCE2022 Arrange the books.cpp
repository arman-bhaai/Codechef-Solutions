...
// Contest ID   :: TWCE2022
// Problem Name :: Arrange the books
// Problem URL  :: https://www.codechef.com/TWCE2022/problems/SHELFARRANGE
...
void solve(){
	...
	cout<<endl<<"COMPILER DESIGN"<<endl<<endl;
	for(int i=201; i<=212; i++){
		if(find(v.begin(), v.end(), i) != v.end()) cout<<i<<" ";
		else cout<<"  ";
		if(i%4==0) cout<<endl;
	}
	cout<<endl<<"DESIGN THINKING"<<endl<<endl;
